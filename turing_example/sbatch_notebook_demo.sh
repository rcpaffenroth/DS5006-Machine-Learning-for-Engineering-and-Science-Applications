...
cd /home/rcpaffenroth/tmp/DSCS553_example/turing_example
venv/bin/jupyter nbconvert --to notebook --execute quickstart_tutorial.ipynb --output=quickstart_tutorial_output.ipynb
